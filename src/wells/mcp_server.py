...
from wells import config, gitops, memory
from wells.compress import compress_output
from wells.config import (
    HARNESS_SAFETY,
    MAX_ITERATIONS,
    MAX_TOOL_STEPS,
    PLAN_MODE,
...
from wells.tools import ToolContext, dispatch, registry

server = mcp.server.Server("wells")
