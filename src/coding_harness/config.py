...
# Load .env from package root (Q:\wells\.env), not from cwd (might be different workspace).
# This ensures API keys and credentials are always found regardless of where wells is run from.
